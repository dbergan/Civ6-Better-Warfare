...
('BW_PROMOTION_LAND_RANGED_ELUSIVE',			'KIND_PROMOTION'),
('BW_PROMOTION_LAND_RANGED_HIT_AND_RUN',		'KIND_PROMOTION'),
('BW_PROMOTION_LAND_RANGED_PRIORITY_TARGET',	'KIND_PROMOTION'),
('BW_PROMOTION_LAND_RANGED_SCREEN',			'KIND_PROMOTION'),
('BW_PROMOTION_LAND_RANGED_FLANK_GUARD',		'KIND_PROMOTION'),
('BW_PROMOTION_LAND_RANGED_SURVIVALIST',		'KIND_PROMOTION')
;
...
('BW_PROMOTION_LAND_RANGED_COVER_FIRE',			''),
('BW_PROMOTION_LAND_RANGED_SUPPRESSIVE_FIRE',	''),
('BW_PROMOTION_LAND_RANGED_BROADHEADS',			''),
('BW_PROMOTION_LAND_RANGED_BARBED_TRILOBATES',	''),
('BW_PROMOTION_LAND_RANGED_GARRISON_TRAINING',	'')
;
