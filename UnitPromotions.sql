...
(Type,											Kind)
VALUES
('BW_PROMOTION_LIGHT_CAVALRY_DOUBLE_TIME',		'KIND_PROMOTION'),
('BW_PROMOTION_LIGHT_CAVALRY_ELUSIVE',			'KIND_PROMOTION'),
('BW_PROMOTION_LIGHT_CAVALRY_HIT_AND_RUN',		'KIND_PROMOTION'),
('BW_PROMOTION_LIGHT_CAVALRY_PRIORITY_TARGET',	'KIND_PROMOTION'),
('BW_PROMOTION_LIGHT_CAVALRY_SCREEN',			'KIND_PROMOTION'),
('BW_PROMOTION_LIGHT_CAVALRY_FLANK_GUARD',		'KIND_PROMOTION'),
('BW_PROMOTION_LIGHT_CAVALRY_SURVIVALIST',		'KIND_PROMOTION')
;
...
(UnitPromotionType,								Level,	Column,	PromotionClass,						Name,												Description) 
VALUES
('BW_PROMOTION_LIGHT_CAVALRY_DOUBLE_TIME',		1,		1,		'BW_PROMOTION_CLASS_LIGHT_CAVALRY',	'BW_LOC_PROMOTION_DOUBLE_TIME_NAME',				'BW_LOC_PROMOTION_DOUBLE_TIME_DESCRIPTION'),
('BW_PROMOTION_LIGHT_CAVALRY_ELUSIVE',			1,		3,		'BW_PROMOTION_CLASS_LIGHT_CAVALRY',	'BW_LOC_PROMOTION_ELUSIVE_NAME',					'BW_LOC_PROMOTION_ELUSIVE_DESCRIPTION'),
('BW_PROMOTION_LIGHT_CAVALRY_HIT_AND_RUN',		2,		1,		'BW_PROMOTION_CLASS_LIGHT_CAVALRY',	'BW_LOC_PROMOTION_HIT_AND_RUN_NAME',				'BW_LOC_PROMOTION_HIT_AND_RUN_DESCRIPTION'),
('BW_PROMOTION_LIGHT_CAVALRY_PRIORITY_TARGET',	2,		3,		'BW_PROMOTION_CLASS_LIGHT_CAVALRY',	'BW_LOC_PROMOTION_PRIORITY_TARGET_NAME',			'BW_LOC_PROMOTION_PRIORITY_TARGET_DESCRIPTION'),
('BW_PROMOTION_LIGHT_CAVALRY_SCREEN',			3,		1,		'BW_PROMOTION_CLASS_LIGHT_CAVALRY',	'BW_LOC_PROMOTION_LIGHT_CAVALRY_SCREEN_NAME',		'BW_LOC_PROMOTION_LIGHT_CAVALRY_SCREEN_DESCRIPTION'),
('BW_PROMOTION_LIGHT_CAVALRY_FLANK_GUARD',		3,		3,		'BW_PROMOTION_CLASS_LIGHT_CAVALRY',	'BW_LOC_PROMOTION_LIGHT_CAVALRY_FLANK_GUARD_NAME',	'BW_LOC_PROMOTION_LIGHT_CAVALRY_FLANK_GUARD_DESCRIPTION'),
('BW_PROMOTION_LIGHT_CAVALRY_SURVIVALIST',		4,		2,		'BW_PROMOTION_CLASS_LIGHT_CAVALRY',	'BW_LOC_PROMOTION_SURVIVALIST_NAME',				'BW_LOC_PROMOTION_SURVIVALIST_DESCRIPTION')
;

INSERT INTO UnitPromotionModifiers
(UnitPromotionType,								ModifierId)
VALUES
('BW_PROMOTION_LIGHT_CAVALRY_DOUBLE_TIME',		'BW_MOD_+1_MOVEMENT'),
('BW_PROMOTION_LIGHT_CAVALRY_ELUSIVE',			'BW_MOD_IGNORE_ZOC'),
('BW_PROMOTION_LIGHT_CAVALRY_HIT_AND_RUN',		'BW_MOD_MOVE_AFTER_ATTACK'),
('BW_PROMOTION_LIGHT_CAVALRY_PRIORITY_TARGET',	'BW_MOD_PRIORITY_TARGET'),
('BW_PROMOTION_LIGHT_CAVALRY_SCREEN',			'BW_MOD_LIGHT_CAVALRY_SCREEN'),
('BW_PROMOTION_LIGHT_CAVALRY_FLANK_GUARD',		'BW_MOD_LIGHT_CAVALRY_FLANK_GUARD'),
('BW_PROMOTION_LIGHT_CAVALRY_SURVIVALIST',		'BW_MOD_SURVIVALIST')
;
