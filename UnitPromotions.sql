...
('BW_PROMOTION_LIGHT_CAVALRY_HAMMER_AND_ANVIL',	'KIND_PROMOTION'),
('BW_PROMOTION_LIGHT_CAVALRY_DUST_STORM',		'KIND_PROMOTION'),
('BW_PROMOTION_LIGHT_CAVALRY_PARTHIAN_SHOT',	'KIND_PROMOTION'),
('BW_PROMOTION_LIGHT_CAVALRY_STRING_OF_HORSES',	'KIND_PROMOTION')
;
...
('BW_PROMOTION_LIGHT_CAVALRY_TERROR_AND_PANIC',	2,		1,		'BW_PROMOTION_CLASS_LIGHT_CAVALRY',	'BW_LOC_PROMOTION_LIGHT_CAVALRY_TERROR_AND_PANIC_NAME',	'BW_LOC_PROMOTION_LIGHT_CAVALRY_TERROR_AND_PANIC_DESCRIPTION'),
('BW_PROMOTION_LIGHT_CAVALRY_ENVELOPE',	2,		3,		'BW_PROMOTION_CLASS_LIGHT_CAVALRY',	'BW_LOC_PROMOTION_LIGHT_CAVALRY_HAMMER_AND_ANVIL_NAME',	'BW_LOC_PROMOTION_LIGHT_CAVALRY_HAMMER_AND_ANVIL_DESCRIPTION'),
('BW_PROMOTION_LIGHT_CAVALRY_DUST_STORM',		3,		1,		'BW_PROMOTION_CLASS_LIGHT_CAVALRY',	'BW_LOC_PROMOTION_LIGHT_CAVALRY_DUST_STORM_NAME',		'BW_LOC_PROMOTION_LIGHT_CAVALRY_DUST_STORM_DESCRIPTION'),
('BW_PROMOTION_LIGHT_CAVALRY_PARTHIAN_SHOT',	3,		3,		'BW_PROMOTION_CLASS_LIGHT_CAVALRY',	'BW_LOC_PROMOTION_LIGHT_CAVALRY_PARTHIAN_SHOT_NAME',	'BW_LOC_PROMOTION_LIGHT_CAVALRY_PARTHIAN_SHOT_DESCRIPTION'),
('BW_PROMOTION_LIGHT_CAVALRY_STRING_OF_HORSES',	4,		2,		'BW_PROMOTION_CLASS_LIGHT_CAVALRY',	'BW_LOC_PROMOTION_LIGHT_CAVALRY_STRING_OF_HORSES_NAME',	'BW_LOC_PROMOTION_LIGHT_CAVALRY_STRING_OF_HORSES_DESCRIPTION')
;
...
('BW_PROMOTION_LIGHT_CAVALRY_HAMMER_AND_ANVIL',	'BW_MOD_'),
('BW_PROMOTION_LIGHT_CAVALRY_DUST_STORM',		'BW_MOD_'),
('BW_PROMOTION_LIGHT_CAVALRY_PARTHIAN_SHOT',	'BW_MOD_'),
('BW_PROMOTION_LIGHT_CAVALRY_STRING_OF_HORSES',	'BW_MOD_')
;
