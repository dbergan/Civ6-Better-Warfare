...
('BW_LOC_RECON_GENERAL', '[NEWLINE][NEWLINE]Recon units cannot attack, but excel at gathering information. By default they can see through terrain features (like woods and rainforests) and reveal stealth units.{BW_LOC_RECON_PROMOTIONS}', 'en_US'),
