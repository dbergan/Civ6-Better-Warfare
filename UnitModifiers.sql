...
('BW_MOD_HEAVY_INFANTRY_OBLIQUE_ORDER',							'Preview',	'+{1_Amount} {BW_LOC_PROMOTION_HEAVY_INFANTRY_OBLIQUE_ORDER_NAME} {LOC_PROMOTION_DESCRIPTOR_PREVIEW_TEXT}'),
...
('BW_MOD_LIGHT_CAVALRY_ENVELOPE2',								'Preview',	'{1_Amount} {BW_LOC_PROMOTION_LIGHT_CAVALRY_ENVELOPE_NAME} (enemy Light Cavalry)'),
('BW_MOD_LIGHT_CAVALRY_DUST_STORM2',							'Preview',	'{1_Amount} {BW_LOC_PROMOTION_LIGHT_CAVALRY_DUST_STORM_NAME} (enemy Light Cavalry)'),
('BW_MOD_LIGHT_CAVALRY_PARTHIAN_SHOT',							'Preview',	'+{1_Amount} {BW_LOC_PROMOTION_LIGHT_CAVALRY_PARTHIAN_SHOT_NAME} {LOC_PROMOTION_DESCRIPTOR_PREVIEW_TEXT}')
;
