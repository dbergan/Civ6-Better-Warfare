...
('BW_MOD_LIGHT_INFANTRY_SCREEN',				'MODIFIER_ALL_UNITS_ATTACH_MODIFIER',					'DB_REQSET_ADJACENT_UNIT_AT_WAR'),
('BW_MOD_LIGHT_INFANTRY_SCREEN2',				'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH',					'DB_REQSET_DEFENDING_MELEE'),
('BW_MOD_LIGHT_INFANTRY_FLANK_GUARD',			'MODIFIER_PLAYER_UNIT_ADJUST_SUPPORT_BONUS_MODIFIER',	null),
...
('BW_MOD_LIGHT_INFANTRY_SCREEN',				'ModifierId',	'BW_MOD_LIGHT_INFANTRY_SCREEN2'),
('BW_MOD_LIGHT_INFANTRY_SCREEN2',				'Amount',		-5),
('BW_MOD_LIGHT_INFANTRY_FLANK_GUARD',			'Percent',		200)
;
...
('BW_MOD_RECON_TROOP_INTEL2',					'Preview',	'{1_Amount} {BW_LOC_PROMOTION_RECON_TROOP_INTEL_NAME}'),
('BW_MOD_LIGHT_INFANTRY_SCREEN2',				'Preview',	'{1_Amount} {BW_LOC_PROMOTION_LIGHT_INFANTRY_SCREEN_NAME}')
;
