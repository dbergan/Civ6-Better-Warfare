...
('BW_LOC_PROMOTION_LAND_RANGED_GARRISON_TRAINING_NAME', 'Garrison Training', 'en_US'),
('BW_LOC_PROMOTION_LAND_RANGED_GARRISON_TRAINING_DESCRIPTION', '+10 [ICON_Strength] attacking from cities and encampments[NEWLINE]+10 [ICON_Strength] attacking and defending from forts', 'en_US'),
-- ('LOC_PEDIA_UNITPROMOTIONS_PAGE_BW_PROMOTION_LAND_RANGED_GARRISON_TRAINING_CHAPTER_HISTORY_PARA_1', '', 'en_US'),
