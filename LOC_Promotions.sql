...
('LOC_PEDIA_UNITPROMOTIONS_PAGE_BW_PROMOTION_HEAVY_INFANTRY_PHALANX_CHAPTER_HISTORY_PARA_1', '', 'en_US'),
...
('BW_LOC_PROMOTION_LIGHT_CAVALRY_ENVELOPE_DESCRIPTION', 'Adjacent enemies: -5 [ICON_Strength] defense in land melee battles', 'en_US'),
...
('BW_LOC_PROMOTION_LIGHT_CAVALRY_DUST_STORM_DESCRIPTION', 'Adjacent enemies: -5 [ICON_Strength] when attacking', 'en_US'),
