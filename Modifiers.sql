...
('BW_MOD_HEAVY_INFANTRY_OBLIQUE_ORDER_VS_HEAVY_INF',			'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH',					'BW_REQSET_OPPONENT_IS_HEAVY_INFANTRY'),
...
('BW_MOD_ARCHER_COVER_FIRE',									'MODIFIER_PLAYER_UNIT_ADJUST_FLANKING_BONUS_MODIFIER',	null),
('BW_MOD_ARCHER_SUPPRESSIVE_FIRE',								'MODIFIER_PLAYER_UNIT_ADJUST_SUPPORT_BONUS_MODIFIER',	null),
('BW_MOD_ARCHER_BROADHEADS',									'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH',					'BW_REQSET_ARCHER_BROADHEADS'),
('BW_MOD_ARCHER_BARBED_TRILOBATES',								'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH',					'BW_REQSET_ARCHER_BARBED_TRILOBATES'),
('BW_MOD_ARCHER_LOOPHOLE_TRAINING',								'MODIFIER_SINGLE_UNIT_ATTACH_MODIFIER',					'BW_REQSET_IN_CITY_ENCAMPMENT_OR_FORT'),
('BW_MOD_ARCHER_LOOPHOLE_TRAINING2',							'MODIFIER_UNIT_ADJUST_COMBAT_STRENGTH',					null),

-- ('BW_MOD_WARRIOR_MONKS_DISCIPLES',								'MODIFIER_PLAYER_UNIT_ADJUST_LAND_VICTORY_SPREAD',		null),
('BW_MOD_WARRIOR_MONKS_ADJ_UNITS_DISCIPLES',					'MODIFIER_PLAYER_UNITS_ATTACH_MODIFIER',				'DB_REQSET_ADJACENT_TO_OR_SAME_TILE_AS_OWNER'),
...
('BW_MOD_HEAVY_INFANTRY_OBLIQUE_ORDER_VS_HEAVY_INF',			'Amount',				5),
...
('BW_MOD_ARCHER_COVER_FIRE',									'Percent',				200),
('BW_MOD_ARCHER_SUPPRESSIVE_FIRE',								'Percent',				200),
('BW_MOD_ARCHER_BROADHEADS',									'Amount',				10),
('BW_MOD_ARCHER_BARBED_TRILOBATES',								'Amount',				10),
('BW_MOD_ARCHER_LOOPHOLE_TRAINING',								'ModifierId',			'BW_MOD_ARCHER_LOOPHOLE_TRAINING2'),
('BW_MOD_ARCHER_LOOPHOLE_TRAINING2',							'Amount',				10),

-- ('BW_MOD_WARRIOR_MONKS_DISCIPLES',								'LandVictorySpread',	1),
('BW_MOD_WARRIOR_MONKS_ADJ_UNITS_DISCIPLES',					'ModifierId',			'BW_MOD_HEAVY_CAVALRY_MORALE_BOOST2'), -- 'BW_MOD_WARRIOR_MONKS_DISCIPLES'),
...
('BW_MOD_HEAVY_INFANTRY_OBLIQUE_ORDER_VS_HEAVY_INF',			'Preview',	'BW_LOC_MOD_HEAVY_INFANTRY_OBLIQUE_ORDER_PREVIEW'),
...
('BW_MOD_ARCHER_BROADHEADS',								'Preview',	'BW_LOC_MOD_ARCHER_BROADHEADS_PREVIEW'),
('BW_MOD_ARCHER_BARBED_TRILOBATES',						'Preview',	'BW_LOC_MOD_ARCHER_BARBED_TRILOBATES_PREVIEW'),
('BW_MOD_ARCHER_LOOPHOLE_TRAINING2',						'Preview',	'BW_LOC_MOD_ARCHER_LOOPHOLE_TRAINING_PREVIEW')
;
...
('BW_MOD_+400PERCENT_SUPPORT_WHEN_NT_ARCHER',		'MODIFIER_PLAYER_UNIT_ADJUST_SUPPORT_BONUS_MODIFIER',	'DB_REQSET_ATTACKING_SEA_UNIT'),
('BW_MOD_+400PERCENT_FLANK_WHEN_NT_ARCHER',		'MODIFIER_PLAYER_UNIT_ADJUST_FLANKING_BONUS_MODIFIER',	'DB_REQSET_ATTACKING_SEA_UNIT'),
...
('BW_MOD_+400PERCENT_SUPPORT_WHEN_NT_ARCHER',		'Percent',	400),
('BW_MOD_+400PERCENT_FLANK_WHEN_NT_ARCHER',		'Percent',	400),
