...
('BW_LOC_MOD_LAND_RANGED_BROADHEADS_PREVIEW', '{DB_POS_AMOUNT}{BW_LOC_PROMOTION_LAND_RANGED_BROADHEADS_NAME} {LOC_PROMOTION_DESCRIPTOR_PREVIEW_TEXT}', 'en_US'),
('BW_LOC_MOD_LAND_RANGED_BARBED_TRILOBATES_PREVIEW', '{DB_POS_AMOUNT}{BW_LOC_PROMOTION_LAND_RANGED_BARBED_TRILOBATES_NAME} {LOC_PROMOTION_DESCRIPTOR_PREVIEW_TEXT}', 'en_US'),
('BW_LOC_MOD_LAND_RANGED_GARRISON_TRAINING_PREVIEW', '{DB_POS_AMOUNT}{BW_LOC_PROMOTION_LAND_RANGED_GARRISON_TRAINING_NAME} {LOC_PROMOTION_DESCRIPTOR_PREVIEW_TEXT}', 'en_US'),
