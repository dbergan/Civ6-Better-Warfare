...
('BW_LOC_MOD_LAND_RANGED_LOOPHOLE_TRAINING_PREVIEW', '{DB_POS_AMOUNT}{BW_LOC_PROMOTION_LAND_RANGED_LOOPHOLE_TRAINING_NAME} {LOC_PROMOTION_DESCRIPTOR_PREVIEW_TEXT}', 'en_US'),
