...
(Type,											Kind)
VALUES
('BW_PROMOTION_ARCHER_DOUBLE_TIME',			'KIND_PROMOTION'),
('BW_PROMOTION_ARCHER_HIT_AND_RUN',			'KIND_PROMOTION'),
('BW_PROMOTION_ARCHER_COVER_FIRE',			'KIND_PROMOTION'),
('BW_PROMOTION_ARCHER_SUPPRESSIVE_FIRE',	'KIND_PROMOTION'),
('BW_PROMOTION_ARCHER_BROADHEADS',			'KIND_PROMOTION'),
('BW_PROMOTION_ARCHER_BARBED_TRILOBATES',	'KIND_PROMOTION'),
('BW_PROMOTION_ARCHER_LOOPHOLE_TRAINING',	'KIND_PROMOTION')
;

DELETE FROM UnitPromotions WHERE PromotionClass = 'BW_PROMOTION_CLASS_ARCHER' ;
INSERT INTO UnitPromotions
(UnitPromotionType,							Level,	Column,	PromotionClass,					Name,												Description) 
VALUES
('BW_PROMOTION_ARCHER_DOUBLE_TIME',			1,		1,		'BW_PROMOTION_CLASS_ARCHER',	'BW_LOC_PROMOTION_DOUBLE_TIME_NAME',				'BW_LOC_PROMOTION_DOUBLE_TIME_DESCRIPTION'),
('BW_PROMOTION_ARCHER_HIT_AND_RUN',			1,		3,		'BW_PROMOTION_CLASS_ARCHER',	'BW_LOC_PROMOTION_HIT_AND_RUN_NAME',				'BW_LOC_PROMOTION_HIT_AND_RUN_DESCRIPTION'),
('BW_PROMOTION_ARCHER_COVER_FIRE',			2,		1,		'BW_PROMOTION_CLASS_ARCHER',	'BW_LOC_PROMOTION_ARCHER_COVER_FIRE_NAME',			'BW_LOC_PROMOTION_ARCHER_COVER_FIRE_DESCRIPTION'),
('BW_PROMOTION_ARCHER_SUPPRESSIVE_FIRE',	2,		3,		'BW_PROMOTION_CLASS_ARCHER',	'BW_LOC_PROMOTION_ARCHER_SUPPRESSIVE_FIRE_NAME',	'BW_LOC_PROMOTION_ARCHER_SUPPRESSIVE_FIRE_DESCRIPTION'),
('BW_PROMOTION_ARCHER_BROADHEADS',			3,		1,		'BW_PROMOTION_CLASS_ARCHER',	'BW_LOC_PROMOTION_ARCHER_BROADHEADS_NAME',			'BW_LOC_PROMOTION_ARCHER_BROADHEADS_DESCRIPTION'),
('BW_PROMOTION_ARCHER_BARBED_TRILOBATES',	3,		3,		'BW_PROMOTION_CLASS_ARCHER',	'BW_LOC_PROMOTION_ARCHER_BARBED_TRILOBATES_NAME',	'BW_LOC_PROMOTION_ARCHER_BARBED_TRILOBATES_DESCRIPTION'),
('BW_PROMOTION_ARCHER_LOOPHOLE_TRAINING',	4,		2,		'BW_PROMOTION_CLASS_ARCHER',	'BW_LOC_PROMOTION_ARCHER_LOOPHOLE_TRAINING_NAME',	'BW_LOC_PROMOTION_ARCHER_LOOPHOLE_TRAINING_DESCRIPTION')
;

INSERT INTO UnitPromotionModifiers
(UnitPromotionType,							ModifierId)
VALUES
('BW_PROMOTION_ARCHER_DOUBLE_TIME',			'BW_MOD_+1_MOVEMENT'),
('BW_PROMOTION_ARCHER_HIT_AND_RUN',			'BW_MOD_MOVE_AFTER_ATTACK'),
('BW_PROMOTION_ARCHER_COVER_FIRE',			'BW_MOD_ARCHER_COVER_FIRE'),
('BW_PROMOTION_ARCHER_SUPPRESSIVE_FIRE',	'BW_MOD_ARCHER_SUPPRESSIVE_FIRE'),
('BW_PROMOTION_ARCHER_BROADHEADS',			'BW_MOD_ARCHER_BROADHEADS'),
('BW_PROMOTION_ARCHER_BARBED_TRILOBATES',	'BW_MOD_ARCHER_BARBED_TRILOBATES'),
('BW_PROMOTION_ARCHER_LOOPHOLE_TRAINING',	'BW_MOD_ARCHER_LOOPHOLE_TRAINING')
;
