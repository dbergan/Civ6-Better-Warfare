...
-- ('TRAIT_CIVILIZATION_UNIT_PERSIAN_WARSHIP',			'BW_MOD_ACTIVATE_PERSIAN_WARSHIP_BONUS'),		unit and trait was removed from Steel and Thunder (but the ability persists from S&T)
...
-- ('TRAIT_CIVILIZATION_UNIT_AZTEC_WARRIOR_PRIEST',	'BW_MOD_ACTIVATE_WARRIOR_PRIEST_BONUS'),			unit and trait was removed from Steel and Thunder (but the ability persists from S&T)
