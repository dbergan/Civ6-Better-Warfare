# Civ6-Better-Warfare  -  What's this github for?
...
1) Go here: https://github.com/dbergan/Civ6-Better-Warfare
2) Click the Green "Clone or Download" button
3) Download ZIP
4) Extract the zip into a folder
5) Move the files into your Better Warfare folder such that they overwrite the existing files with the same names

My Better Warfare folder is here:
C:\SteamLibrary\steamapps\workshop\content\289070\1871143279
...
2) Once it's created and you've logged in, go here: https://github.com/dbergan/Civ6-Better-Warfare
...
2) Once it's created and you've logged into github, go here: https://github.com/dbergan/Civ6-Better-Warfare

3) Click the Fork icon in the top-right area of the page. What this does is copy all of the files from the master codepage into your own personal directory. Once you clicked that button, you'll notice in the top-left that it will say "MyUserName / Civ6-Better-Warfare" now instead of "dbergan / Civ6-Better-Warfare". You'll see the same change in the URL "https://github.com/MyUserName/Civ6-Better-Warfare".
